    ...
    <main class="cd__main">
        ...
        <div class="profile-page">
            <div class="content">
                ...
                <div class="content__actions"><a href="tel:+<?php echo $users['phone']; ?>">
                        ...
                        </svg><span>Connect</span></a><a href="tel:+<?php echo $users['phone']; ?>">
                ...
                <div class="content__title">
                    <h1> <?php echo $users['f_name']; ?> </h1>
                </div>
                <div class="content__description">

                    <p>First Name :<?php echo $users['f_name']; ?></p>
                    <p>Last Name<?php echo $users['l_name']; ?></p>
                    <p>Email :<?php echo $users['email']; ?></p>
                    <p>Phone Number :<?php echo $users['phone']; ?></p>
                    <p>Password :<?php echo $users['password']; ?></p>
                </div>
                <div class="content__button"><a class="button" href="/logout.php">
